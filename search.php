...
<style>
	...
	<?php
		...
		if(!empty($_GET["dosearch"]) && ($_GET["dosearch"] == "true"))
		{
				...
				while($row = $result->fetch_assoc())
				{
					...
					echo "<table  class='table table-hover'>";
						...
						echo "<tr>";
								...
								echo '</td>';
								echo '<td>';
								echo "<a href='http://localhost/PatientProfile.php?hid=$hid'>".$fname."</a>";
								echo '</td>';
								echo '<td>';
								echo "<a href='http://localhost/PatientProfile.php?hid=$hid'>".$lname."</a>";
								echo '</td>';
								echo '<td>';
								echo $dob;
								echo '</td>';
